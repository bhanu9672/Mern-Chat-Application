...
import { formatMessageTime } from "../libary/utils"
	...
	return selectedUser ? (
		<div className='h-full overflow-scroll relative backdrop-blur-lg'>
			...
			<div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
				<img
					src={selectedUser.profilePic || assets.profile_martin} alt=""
				...
				<img
					...
					src={assets.help_icon} className="md:hidden max-w-7" alt=""
				/>
			...
			<div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
				...
				{messages.map((msg, index) => (
					<div
						key={index}
						className={
							`flex items-end gap-2 justify-end ${msg.senderId !== authUser._id && 'flex-row-reverse'
							}`
						}
					>
						{msg.image ? (
